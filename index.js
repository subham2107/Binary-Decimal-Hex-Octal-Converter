...
const user_response = parseInt(readLineSync.question('Welcome to Binary/Decimal/Hex/Octal Converter. Which conversion would you like to use?\n1. binaryToDecimal\n2. binaryToHex\n3. binaryToOctal\n4. decimalToBinary\n5. decimalToHex\n6. decimalToOctal\n7. hexToDecimal\n8. hexToOctal\n9. hexToBinary\n10. octalToDecimal\n11. octalToHex\n12. octalToBinary\n'));
...
{
return parseInt(input).toString(8);
}
...
switch(user_response)
{
  ...
  break;
  case 4:
  const input4 = readLineSync.question('Please enter your input in decimal\n');
  console.log(decimalToBinary(input4));
  break;
  case 5:
  const input5 = readLineSync.question('Please enter your input in decimal\n');
  console.log(decimalToHex(input5));
  break;
  case 6:
  const input6 = readLineSync.question('Please enter your input in decimal\n');
